...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    try {
        ...
        // Devamsızlık kayıtlarını getir (normal + ek ders)
        $attendanceQuery = "
            SELECT 
                id, ogrenci_id, ogretmen_id, grup, tarih, durum, zaman, yontem,
                COALESCE(ders_tipi, 'normal') as ders_tipi,
...
The provided change snippet replaces the attendance query. The original code has two attendance queries. I'll apply the change to the first attendance query which gets all attendance records and to the recent attendance query which gets the latest 10 records.
