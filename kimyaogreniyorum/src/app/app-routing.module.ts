...
import { KullaniciOdevlerinCevaplariSayfasiComponent } from './components/kullanici-sayfalari/kullanici-odevlerin-cevaplari-sayfasi/kullanici-odevlerin-cevaplari-sayfasi.component';
...
const routes: Routes = [
  ...
  //kullanicilar Sayfalari
  {
    ...
    children: [
      ...
      {
        path: 'odevlerin-cevaplari-sayfasi',
        component: KullaniciOdevlerinCevaplariSayfasiComponent,
      },
      {
  ...
  //öğretmenler sayfaları
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: OgretmenTestlerinCevaplariSayfasiComponent,
      },
      {
      ...
      },
      {
        ...
        component: OgretmenOdevSayfasiComponent,
      },
      {
        path: 'konular',
  ...
  //dovme sayfaları
  {
    ...
    children: [
      {
        path: '',
        component: DovmeSayfasiHeaderSayfasiComponent,
      },
      {
        path: 'randevu',
