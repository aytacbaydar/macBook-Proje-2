...
@Component({
  selector: 'app-ogrenci-testlerin-cevaplari-sayfasi',
  standalone: false,
  templateUrl: './ogrenci-testlerin-cevaplari-sayfasi.component.html',
  styleUrl: './ogrenci-testlerin-cevaplari-sayfasi.component.scss',
})
export class OgrenciTestlerinCevaplariSayfasiComponent implements OnInit {
