...
import { OgrenciCevapAnahtariSayfasiComponent } from './ogrenci-cevap-anahtari-sayfasi/ogrenci-cevap-anahtari-sayfasi.component';
...
@NgModule({
  declarations: [
    ...
    OgrenciCevapAnahtariSayfasiComponent,
  ],
  imports: [
    CommonModule,
    ReactiveFormsModule,
