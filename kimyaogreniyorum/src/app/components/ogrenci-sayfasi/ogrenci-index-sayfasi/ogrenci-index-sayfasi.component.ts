...
@Component({
  selector: 'app-ogrenci-index-sayfasi',
  templateUrl: './ogrenci-index-sayfasi.component.html',
  styleUrls: ['./ogrenci-index-sayfasi.component.scss'],
  standalone: false,
})
export class OgrenciIndexSayfasiComponent implements OnInit {
