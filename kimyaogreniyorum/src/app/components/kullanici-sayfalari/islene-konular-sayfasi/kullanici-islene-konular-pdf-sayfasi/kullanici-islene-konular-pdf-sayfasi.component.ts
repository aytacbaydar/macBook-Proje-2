...
@Component({
  selector: 'app-kullanici-islene-konular-pdf-sayfasi',
  standalone: false,
  templateUrl: './kullanici-islene-konular-pdf-sayfasi.component.html',
  styleUrl: './kullanici-islene-konular-pdf-sayfasi.component.scss',
})
export class KullaniciIsleneKonularPdfSayfasiComponent implements OnInit {
